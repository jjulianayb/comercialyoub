...
export function PropostaInterativa({
  ...
  return (
    <div className="proposta proposta-locked proposal-dynamic">
      ...
      <section className="sec-soft"><div className="sec-inner"><span className="eyebrow">09 — Continuidade</span><h2 className="sec-h">Plano <span>Enterprise</span></h2><p className="sec-sub">Depois da implantação, a Lagoapar pode manter o DHO ativo dentro da plataforma.</p><div className="ctx-box enterprise-box"><h3>R$ {content.enterprise.price} por mês</h3><p>{content.enterprise.description}</p><ul className="plano-lista">{content.enterprise.items.map((item) => <li key={item}>{item}</li>)}</ul></div></div></section>
